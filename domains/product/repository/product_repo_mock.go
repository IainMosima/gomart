...
//
//	mockgen -source=product_int.go -destination=product_repo_mock.go -package=repository
//
...
func (mr *MockProductRepositoryMockRecorder) GetByCategory(ctx, categoryID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductRepositoryMockRecorder) GetByID(ctx, productID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
